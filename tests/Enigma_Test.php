...
class Enigma_Test extends TestCase {
    ...
    public function testBasics() {
        ...
        $text4 = "THESE VIOLENT DELIGHTS HAVE VIOLENT ENDS AND IN THEIR TRIUMPH DIE LIKE FIRE AND ICE WHICH AS THEY KISS CONSUME";
        $cipherText4 = "Y.U!LM.!RW GPVGBC!-YYW.CTIXXNUX UPAMXY& EYRWQVTX.Y TNVALGVCQZLKMLMC!X?E&?TLM!Y&SAOUV?NGQISIW.RUBDXXU?W.HJHBVC?";
